...
public class Player : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if ( (pRig2D.linearVelocityY < 0) && (rayHit.collider != null) )
        {
    ...
    void KeyInput()
    {
        ...
        if (Input.GetMouseButtonDown(0)) //0 = 왼쪽마우스, 1 == 오른쪽마우스, 2 == 휠
        {
    ...
    {
        //플레이어 오른쪽
        GameObject slashing = Instantiate(slash, transform.position, Quaternion.identity);
        Destroy(slashing, 0.5f);
    }

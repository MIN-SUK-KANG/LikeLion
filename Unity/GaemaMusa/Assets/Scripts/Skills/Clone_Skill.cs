...
public class Clone_Skill : Skill
{
    ...
    [SerializeField] private bool canCreateCloneOnCounterAttack; // 카운터 어택 시 클론 생성 가능 여부
    ...
    [Header("Crystal 필살기")]
    public bool crystalInsteadOfClone;                  // 클론 대신 크리스탈 사용 여부

    // 클론 생성 함수
    public void CreateClone(Transform _clonePosition , Vector3 _offset)
    {
        // 클론 대신 크리스탈 사용 설정이 되어있다면 크리스탈 생성
        ...
        newClone.GetComponent<Clone_Skill_Controller>().SetupClone
            (_clonePosition, cloneDuration, canAttack, _offset, FindClosestEnemy(newClone.transform), canDuplicateClone, chanceToDuplicate);
    }
    // 지연 후 클론 생성 코루틴
